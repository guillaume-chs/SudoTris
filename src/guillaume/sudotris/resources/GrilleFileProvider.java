...
/**
 * Cette classe gère l'accès aux grilles partielles remplies de jeu, ou complètement complétées de vérification.
 *
...
public class GrilleFileProvider {
    ...
    /**
     * Renvoie le chemin d'accès à la grille partiellement remplie de jeu, en fonction du niveau de difficulté donné.
     *
     * @param difficulte le niveau de difficulté de la partie.
     * @return le chemin d'accès à la grille partiellement remplie de jeu
     */
    ...
    /**
     * Renvoie le chemin d'accès à la grille complétée, en fonction du niveau de difficulté donné.
     *
     * @param difficulte le niveau de difficulté de la partie.
     * @return le chemin d'accès à la grille complétée
     */
